...
<!---------------------------------------- 수신함 모달창 열기 ---------------------------------------->
      ...
      <div id="inbox-modalWrap">
        <div class="inbox-modalBody">
          <span id="inbox-closeBtn">
            <img src="${contextPath}/resources/images/Xbtn.png" alt="">
          </span>
          <form action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="inbox-modal-header">
              <!-- 제목 -->
              <h1 class="inbox-modal-title">결재 예시</h1>
              <!-- 결재항목박스 -->
              <div class="inbox-modal-modal-headerbox">
                <!-- 결재항목 내용 -->
                <div class="inbox-modal-headerbox-content">
                  <!-- 문서번호 -->
                  <span class="inbox-modal-modal-headerbox-content-a">문서번호 :</span>  
                  <span class="inbox-modal-modal-headerbox-content-b">2023-05-26-20001990</span>
                </div>
                
                <div class="inbox-modal-headerbox-content">
                  <!-- 작성자 -->
                  <span class="inbox-modal-headerbox-content-a">작성자 :</span>  
                  <span class="inbox-modal-headerbox-content-b">이재혁 ( abcde@gmail.com )</span>
                </div>
                <div class="inbox-modal-headerbox-content">
                  <!-- 작성일 -->
                  <span class="inbox-modal-modal-headerbox-content-a">작성일 :</span>  
                  <span class="inbox-modal-modal-headerbox-content-b">2023-05-26 14:19</span>
                </div>

                <div class="inbox-modal-headerbox-footer">
            ...
            <div class="inbox-modal-table-body">
          ...
          <!-- 내용 -->
          <div class="inbox-modal-detail">
            <p>내용</p>
            <textarea name="" id="" onkeydown="handleResizeHeight(this)"
              onkeyup="handleResizeHeight(this)"></textarea>
          </div>
          <!-- 의견 -->
          <div class="inbox-modal-coment">
            <p>의견</p>
            <input type="text">
          </div>
          <!-- 결재자 -->
          <div class="inbox-modal-approver">
            <p>결재자</p>
            <input type="text">
          </div>
          ...
          <div class="work-modal-line"></div>
          <!-- 최종승인 버튼 -->
          <div class="inbox-modal-checkbox">
            <label for="">
              <input type="checkbox" id='inbox-modal-checkbox' onclick='is_inboxed()'> 
              최종 승인
            </label>
          </div>
          ...
          <div class="work-submit-reset-btns">
            ...
            <button type="reset" id="inbox-cancell-btn">결재취소</button>
            <button id="inbox-success-btn">확인</button>
          </div>
          </form>
        </div>
      </div>
